...
\begin{resume}
    ...
    Relevant Coursework: Programming and Intro Data Structures, Data Structures and Algorithms, Discrete Math
    ...
    \begin{parcolumns}[rulebetween,colwidths={5=2cm,1=2cm}]{6}
        ...
        \colchunk[6]{\\AWS\\Azure Cloud\\Bootstrap\\JQuery\\Entity Framework}
    \end{parcolumns}
