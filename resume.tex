...
\section{EXPERIENCE}
                ...
                {\sl Research Assistant}
                 ...
                 \item Used Standard Template Library containers and algorithms
                 to maximize performance on a large project, 
                 and version control systems to track changes.
                \end{itemize}
...
\begin{parcolumns}[rulebetween,colwidths={1=3cm}]{5}
  ...
  \colchunk[4]{\\TFS\\AWS Lambda\\AWS API Gateway\\AWS DynamoDB\\Flask}
  \colchunk[5]{\\React\\Perf\\SQLite\\Hadoop}
\end{parcolumns}
