...
\hfill April 2019\\ 
                 ...
                 {\sl Minor, Mathematics}\hfill 3.50/4.00 GPA\\
                 {\sl Engineering Honors Program}\\
                 Technical Electives: System Design of a Search Engine, Operating Systems, 
                 Web Systems, Networking, Machine Learning
...
\begin{itemize}[label={}]  \itemsep -2pt %reduce space between items
    \item \textbf{C\texttt{++}, Make, GDB:}
        ...
        prioritizing frontier of links, managing set of seen pages, caching Robots.txt files.
